...
exports = module.exports = require('ene-node-gyp-build')(path.join(__dirname, '..'));
...
['bool', 'byte', 'char', 'uchar', 'short', 'ushort', 'int', 'uint', 'long', 'ulong', 'longlong', 'ulonglong', 'size_t'].forEach((name) => {
